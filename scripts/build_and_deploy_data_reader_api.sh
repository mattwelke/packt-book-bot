...
ACTION_NAME="data-reader-api"

BUILD_DIR="data-reader-api/build"
JAR_PATH="${BUILD_DIR}/libs/data-reader-api-all.jar"

rm -r $BUILD_DIR 2> /dev/null

./gradlew data-reader-api:shadowJar
...
ibmcloud fn action update $ACTION_NAME $JAR_PATH \
  --main "com.mattwelke.packtbookbot.DataReaderApiAction" \
