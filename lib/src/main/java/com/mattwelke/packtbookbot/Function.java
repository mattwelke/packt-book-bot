...
public class Function extends Action {
        ...
        public Map<String, Object> invoke(Map<String, Object> params) {
                try {
                        ...
                        if (freeBookEls.size() == 0) {
                                System.err.println("Selector (" + freeBookPageTitleSelector
                                                + ") found no elements. Cannot continue.");
                        }
                        if (freeBookEls.size() > 1) {
                                System.err.println(
                                                "Selector (" + freeBookPageTitleSelector
                                                                + ") found multiple elements. Cannot continue.");
                        }
        ...
        private static String productPageURL(String title) throws IOException {
                ...
                Stream<Element> matchingSearchEls = searchEls.stream()
        ...
        private static String googleSearchURL(String title) {
                String googleSearchQuery = String.format("\"%s\" site:packtpub.com -site:subscription.packtpub.com",
                                title);
