package com.mattwelke.owr.java;
...
public abstract class Action {
    /**
     * The cluster context, aka "OpenWhisk variables", implemented in official
     * runtimes by mutating the environment variables at runtime (no longer allowed by Java 9+). In this runtime,
     * implemented as state contained within the parent class of the user's action.
     */
